...
def use_printer_with_text(printer: Printer, text: str):
...
@printer_workflow
def use_printer_with_document(printer: Printer, document: str):
...
use_printer_with_document(printer=hp_white, document="I am white.")
